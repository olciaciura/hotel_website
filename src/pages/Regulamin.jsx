...
export function Regulamin(){
    return (
        ...
        <div className='place'>     
            <div id='regulamin'>            
            <p><br/><br/><b>Sugestie i prośby od „gospodarskiego oka”:</b>
            ...
            <br/>- ściąganie hamaków na wieczór i przy deszczowej pogodzie (szybko łapią wilgoć i rano zamiast wygodnie 
                się w nich  wylegiwać, trzeba będzie najpierw poczekać, aż wyschną), 
