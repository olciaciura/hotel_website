...
export function Offer(){
    ...
    return(
        ...
        <div className='place'>
            <img className='offer' id='photo_place' src='../../offer/dom.jpg'/>
            <div id='place'>
                <p><span id='nazwa'> Chwila... Moment </span> składa się z dwóch niezależnych apartamentów połączonych wspólnym tarasem:
        ...
        <div className='place'>
            ...
            <img className='offer' id='photo_place' src='../../offer/kuchnia.jpg'/>
        </div>
        
        <div className='place'>
            <img className='offer' id='photo_place' src='../../offer/okolica.jpg'/>
            <div id='place'>            
            <p>Nie ma telewizji, ani telewizorów. W zamian oddaję  do Waszej dyspozycji książki, 
            ...
            <div id='place'>            
            <p>
                Wspólnie i aktywnie – niezliczone możliwości: w zimie narty zjazdowe w okolicznych 
                    ...
                    zakładce „Przydatne informacje”.</p>
            </div>
            <img className='offer' id='photo_place' src='../../offer/okolica2.jpg'/>
        </div>

        <div className='place'>
            <img className='offer' id='photo_place' src='../../offer/okolica3.jpg'/>
            <div id='place'>            
            <p>Dla miłośników rowerów
            ...
            przedsionku. Jeśli wolelibyście inaczej, możemy też poszukać innego rozwiązania.</p>
            </div>
        </div>
        </div>
